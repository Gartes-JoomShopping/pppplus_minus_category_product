...
foreach($this->languages as $lang){
   ...
   $seoname="seoname_".$lang->language;
   $alias="alias_".$lang->language;
   $description="description_".$lang->language;
   $haracter = "haracter_".$lang->language;
   $komplect = "komplect_".$lang->language;
       ...
       <tr>
         ...
         <td>
           ...
           ?>
	   	   ...
	   	   <tr>
         <td  class="key">
           <?php echo _JSHOP_HARACTER;?>
         </td>
         <td>
           <?php
              $editor = JFactory::getEditor();
              print $editor->display('haracter'.$lang->id,  $row->$haracter , '100%', '200', '75', '20' ) ;
           ?>
         </td>
       </tr>
	   <tr>
         <td  class="key">
           <?php echo _JSHOP_KOMPLECT;?>
         </td>
         <td>
           <?php
              $editor = JFactory::getEditor();
              print $editor->display('komplect'.$lang->id,  $row->$komplect , '100%', '200', '75', '20' ) ;
           ?>
         </td>
       </tr>
       <tr>
