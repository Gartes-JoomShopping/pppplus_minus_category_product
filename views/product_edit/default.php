...
$doc->addStyleSheet(\Joomla\CMS\Uri\Uri::root(true) .'/plugins/jshoppingproducts/pppplus_minus_category_product/assets/css/pppplus_minus_category_product.admin.product_edit.css') ;
...
$Jpro['load'][] = [
    'u' => \Joomla\CMS\Uri\Uri::root(true) .'/plugins/jshoppingproducts/pppplus_minus_category_product/assets/js/pppplus_minus_category_product.admin.product_edit.js' , // Путь к файлу
...
<?php echo JHtml::_('form.token');
    ...
    /*echo'<pre>';print_r( $this->languages[0] );echo'</pre>'.__FILE__.' '.__LINE__;
    die(__FILE__ .' '. __LINE__ );*/


    $name = "name_". $this->languages[0]->language;
...
<!--    </div>-->
    ...
    <div class="headFields">
        ...
        <!--        Hits -->
        <div class="control hits">
            <div class="control-label">
                Hits
            </div>
            <div class="control-input">
                <input type="text" class="inputbox wide" name="hits" value="<?php echo $row->hits?>" />

            </div>
            <div class="btn-wrapper"  >
                <button type="button" onclick="window.pppplusAdminProductEdit.onToTop(event);" class="btn btn-small   btn-success">
...
<input type="hidden" name="last_user" value="<?php echo JFactory::getUser()->id ?>" />
<input type = "hidden" name = "product_ean" value = "<?php echo '000'.$row->product_id?>" /> 
</form>
</div>
